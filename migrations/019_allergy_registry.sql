...
--     submission state and the captured details. We keep history flat (no
...
CREATE TABLE IF NOT EXISTS allergy_records (
  ...
  -- 'pending' until the recipient submits, 'submitted' afterwards. 'none'
  -- means the recipient explicitly declared no allergies.
